...
class TestPerson(TestCase):
    ...
    def has_children(self, person: Person, children: list[Person]) -> None:
    ...
    def test_set_father(self) -> None:
        ...
        self.has_children(self.person_1, [self.person_3])
        ...
        self.assertIsNone(self.person_1.father)
        self.assertIsNone(self.person_1.mother)
        self.has_children(self.person_1, [self.person_3, self.person_4])
    ...
    def test_father_add_child(self) -> None:
        ...
        self.assertEqual(self.person_3.father, self.person_1)
        self.assertIsNone(self.person_3.mother)
        self.assertEqual(0, self.person_3.get_child_count())
    ...
    def test_set_mother(self) -> None:
        ...
        self.has_children(self.person_2, [self.person_3])

        self.assertIsNone(self.person_3.father)
        self.assertEqual(self.person_2, self.person_3.mother)
        self.assertEqual(0, self.person_3.get_child_count())
        ...
        self.assertIsNone(self.person_2.father)
        self.assertIsNone(self.person_2.mother)
        self.has_children(self.person_2, [self.person_3, self.person_4])
        ...
        self.assertEqual(self.person_2, self.person_4.mother)
        self.assertEqual(self.person_4.get_child_count(), 0)
    ...
    def test_change_father_set_father(self) -> None:
        ...
        self.assertEqual(self.person_3, self.person_4.father)
        self.has_children(self.person_3, [self.person_4])

        self.person_4.father = self.person_1

        self.assertEqual(self.person_4.father, self.person_1)
        self.assertEqual(self.person_3.get_child_count(), 0)
        self.has_children(self.person_1, [self.person_4])
    ...
    def test_change_mother_set_mother(self) -> None:
        ...
        self.assertEqual(self.person_3.mother, self.person_4)
        self.has_children(self.person_4, [self.person_3])
    ...
    def test_change_mother_add_child(self) -> None:
        ...
        self.assertEqual(self.person_4, self.person_3.mother)
        self.has_children(self.person_4, [self.person_3])
